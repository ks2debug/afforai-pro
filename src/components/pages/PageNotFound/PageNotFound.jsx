...
const PageNotFound = (props) => {
  ...
  return (
    <div className="utils-container d-flex align-items-center justify-content-center vh-100">
      ...
      <img
        ...
        alt="Error 404"
        onClick={() => {
          navigate(Constants.ENUM_PATH.LOGIN, { replace: false, state: { dataFomrPageNotFound: 'Hari leela kalptaru' } });
        }}
      />
    </div>
  );
